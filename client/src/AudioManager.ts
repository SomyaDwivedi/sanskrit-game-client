...
class AudioManager {
  ...
  constructor() {
    ...
    this.sounds = {
      ...
      buzzerOpen: new Audio('https://assets.mixkit.co/active_storage/sfx/2865/2865-preview.mp3'),
      buzz: new Audio('https://assets.mixkit.co/active_storage/sfx/3005/3005-preview.mp3'),
      teamBuzz: new Audio('https://assets.mixkit.co/active_storage/sfx/2869/2869-preview.mp3'),
      otherBuzz: new Audio('https://assets.mixkit.co/active_storage/sfx/1626/1626-preview.mp3'),
      secondChance: new Audio('https://assets.mixkit.co/active_storage/sfx/146/146-preview.mp3'),
      
      // Answer result sounds
      correct: new Audio('https://assets.mixkit.co/active_storage/sfx/2013/2013-preview.mp3'),
      otherCorrect: new Audio('https://assets.mixkit.co/active_storage/sfx/957/957-preview.mp3'),
      wrong: new Audio('https://assets.mixkit.co/active_storage/sfx/2883/2883-preview.mp3'),
      otherWrong: new Audio('https://assets.mixkit.co/active_storage/sfx/132/132-preview.mp3'),
      
      // Timer and notification sounds
      timeout: new Audio('https://assets.mixkit.co/active_storage/sfx/1059/1059-preview.mp3'),
      timerTick: new Audio('https://assets.mixkit.co/active_storage/sfx/1529/1529-preview.mp3'),
      error: new Audio('https://assets.mixkit.co/active_storage/sfx/3137/3137-preview.mp3'),
      
      // Game progression sounds
      nextQuestion: new Audio('https://assets.mixkit.co/active_storage/sfx/2588/2588-preview.mp3'),
    ...
    this.bgMusic = new Audio('https://assets.mixkit.co/active_storage/sfx/1393/1393-preview.mp3');
  ...
  playSound(soundName: string) {
    if (this.enabled && this.sounds[soundName]) {
      ...
      if (['buzz', 'correct', 'wrong', 'timeout', 'secondChance'].includes(soundName)) {
        ...
        const soundClone = this.sounds[soundName].cloneNode() as HTMLAudioElement;
